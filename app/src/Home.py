...
st.title('Coop - A new kind of networking')
st.write('\n\n')
...
if st.button("Act as James, a student currently looking for a coop", 
            type = 'primary', 
    ...
    st.session_state['StuID'] = 8
    st.session_state['profile_view_StuID'] = 8
    # finally, we ask streamlit to switch to another page, in this case, the 
    # landing page for this particular user type
    logger.info("Logging in as student looking for a co-op")
    st.switch_page('pages/61_Newcooper_Home.py')

if st.button('Act as Mordecai, a student currently on co-op', 
            type = 'primary', 
            use_container_width=True):
    st.session_state['authenticated'] = True
